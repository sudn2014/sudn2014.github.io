...
<div class="post-content" style="text-align: justify; line-height: 1.6; font-family: 'Georgia', serif; max-width: 800px; margin: 0 auto; clear: both;">
  ...
  <h2 style="text-align: left; margin-top: 2em; margin-bottom: 1em; color: #333;">A Bit More About Me</h2>
  <ul style="margin-bottom: 1.5em; padding-left: 1.5em;">
    <li><strong>Background</strong>: I started tinkering with code in high school and haven't looked back. Today, I'm passionate about building open-source tools and exploring AI.</li>
    <li><strong>What You'll Find Here</strong>:
      <ul style="list-style-type: disc; padding-left: 1.5em; margin-top: 0.5em;">
        <li>Tutorials on Jekyll setups, Python scripts.</li>
        <li>Reflections on daily reads or tech trends.</li>
        <li>Random musings (because why not?).</li>
      </ul>
    </li>
...
<style>
  /* Optional: Mobile tweak for justified text (it can look uneven on small screens) */
